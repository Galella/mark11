...
@section('title', 'Gate Out - Terminal Management System')

@section('content-header')
<div class="row">
    <div class="col-sm-6">
        <h1 class="m-0">Gate Out</h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="col-md-12">
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Container Gate Out</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('gate.process-out') }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-danger">Process Gate Out</button>
